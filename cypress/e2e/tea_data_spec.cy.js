describe('Customer Data View', () => {
    ...
    it('displays the customer details on page load' , () => {
        ...
        cy.get('.teaView > :nth-child(1) > :nth-child(3)').should('include.text', 'Recommended Temperature')
        cy.get('.teaView > :nth-child(1) > :nth-child(4)').should('be.visible')
        cy.get('.teaView > :nth-child(1) > :nth-child(4)').should('include.text', 'Recommended Brew Time')
        ...
        cy.get(':nth-child(27) > :nth-child(3)').should('include.text', 'Recommended Temperature')
